...
# ── Header ────────────────────────────────────────────────────────────────────
st.markdown("<h1>⚖️ FairCheck AI 1.0 <span style='font-size:18px; color:gray;'>by</span> <span style='font-size:38px; color:white;'>Colon DoubleSlash</span></h1>", unsafe_allow_html=True)
